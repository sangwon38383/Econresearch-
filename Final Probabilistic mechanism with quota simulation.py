...
def utilitymat():
    ...
    VAA=np.vstack((2*np.random.rand(stuA_num,objA_num),np.zeros((stuB_num,objA_num))))
...
plt.plot(['No','5','4','3','2','1','0'],average_ranks,'b', marker='o')
...
plt.show()
fig.savefig('Efficieny-average welfare.png')
plt.plot(['No','5','4','3','2','1','0'],first_probs,'r', marker='o')
plt.xlabel('major quota')
...
plt.show()
fig.savefig('Efficieny-representative welfare.png')
plt.plot(['No','5','4','3','2','1','0'],envy_counts,'g', marker='o')
plt.xlabel('major quota')
...
plt.plot(ppp1, proportion_ge[1], marker='o',label='quota 5')
plt.plot(ppp1, proportion_ge[2], marker='o',label='quota 4')
plt.plot(ppp1, proportion_ge[3], marker='o',label='quota 3')
plt.plot(ppp1, proportion_ge[4], marker='o',label='quota 2')
plt.plot(ppp1, proportion_ge[5], marker='o',label='quota 1')
plt.plot(ppp1, proportion_ge[6], marker='o',label='quota 0')
...
plt.plot(ppp2, proportion_Ap[1], marker='o', label='quota 5')
plt.plot(ppp2, proportion_Ap[2], marker='o', label='quota 4')
plt.plot(ppp2, proportion_Ap[3], marker='o', label='quota 3')
plt.plot(ppp2, proportion_Ap[4], marker='o', label='quota 2')
plt.plot(ppp2, proportion_Ap[5], marker='o', label='quota 1')
plt.plot(ppp2, proportion_Ap[6], marker='o', label='quota 0')
