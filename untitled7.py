...
plt.plot(qqq,average_ranks,'b',label='average rank')
plt.plot(qqq,first_probs,'r',label='getting first course probability')
plt.plot(qqq,envy_counts,'g', label='envyness')
plt.xlabel('major quota')
plt.ylabel('rank or probability or envyness')
plt.title('modified probabilistic serial mechanism')
plt.legend(loc='upper right')
plt.show()

ppp1=np.array(range(objA_num+objB_num, obj_num))
plt.plot(ppp1, proportion_ge[0], label='No quota')
plt.plot(ppp1, proportion_ge[1], label='quota 30')
plt.plot(ppp1, proportion_ge[2], label='quota 25')
plt.plot(ppp1, proportion_ge[3], label='quota 20')
plt.plot(ppp1, proportion_ge[4], label='quota 15')
plt.plot(ppp1, proportion_ge[5], label='quota 10')
plt.plot(ppp1, proportion_ge[6], label='quota 5')
...
ppp2=np.array(range(0,objAp_num))
plt.plot(ppp2, proportion_ge[0], label='No quota')
plt.plot(ppp2, proportion_ge[1], label='quota 30')
plt.plot(ppp2, proportion_ge[2], label='quota 25')
plt.plot(ppp2, proportion_ge[3], label='quota 20')
plt.plot(ppp2, proportion_ge[4], label='quota 15')
plt.plot(ppp2, proportion_ge[5], label='quota 10')
plt.plot(ppp2, proportion_ge[6], label='quota 5')
